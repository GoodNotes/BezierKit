...
class ShapeTests: XCTestCase {
    let testQuadCurve = QuadraticCurve(p0: Point(x: 0.0, y: 0.0), p1: Point(x: 1.0, y: 1.0), p2: Point(x: 1.0, y: 2.0))

    func testShapeIntersection() {
        let c1 = LineSegment(p0: Point(x: 0.0, y: 1.0), p1: Point(x: 1.0, y: 0.0))
        let c2 = LineSegment(p0: Point(x: 0.0, y: 1.0), p1: Point(x: 1.0, y: 2.0))
        let c3 = LineSegment(p0: Point(x: 0.0, y: 10.0), p1: Point(x: 1.0, y: 5.0))
    ...
    func testIntersects() {
        let epsilon = 1.0e-4
        let line1 = LineSegment(p0: Point(x: -1, y: -1), p1: Point(x: 1, y: 1))
        ...
        let line2 = LineSegment(p0: Point(x: 1.0, y: 10.0), p1: Point(x: 1.0, y: -10.0))
        ...
        let s3 = LineSegment(p0: Point(x: -3, y: -3), p1: Point(x: 3, y: 3)).outlineShapes(distance: 1)
        XCTAssertEqual(s1.intersects(shape: s3[0]), [])
        // test a non-intersecting case where bounding boxes do not overlap
        let s4 = LineSegment(p0: Point(x: -6, y: -6), p1: Point(x: -4, y: -4)).outlineShapes(distance: sqrt(2))
