...
class LineSegmentTests: XCTestCase {
    ...
    func testInitializerArray() {
        let l = LineSegment(points: [Point(x: 1.0, y: 1.0), Point(x: 3.0, y: 2.0)])
        XCTAssertEqual(l.p0, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(l.p1, Point(x: 3.0, y: 2.0))
        XCTAssertEqual(l.startingPoint, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(l.endingPoint, Point(x: 3.0, y: 2.0))
    }

    func testInitializerIndividualPoints() {
        let l = LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.0, y: 2.0))
        XCTAssertEqual(l.p0, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(l.p1, Point(x: 3.0, y: 2.0))
        XCTAssertEqual(l.startingPoint, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(l.endingPoint, Point(x: 3.0, y: 2.0))
    ...
    func testBasicProperties() {
        let l = LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 2.0, y: 5.0))
        XCTAssert(l.simple)
        XCTAssertEqual(l.order, 1)
        XCTAssertEqual(l.startingPoint, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(l.endingPoint, Point(x: 2.0, y: 5.0))
    }

    func testSetStartEndPoints() {
        var l = LineSegment(p0: Point(x: 5.0, y: 6.0), p1: Point(x: 8.0, y: 7.0))
        l.startingPoint = Point(x: 4.0, y: 5.0)
        XCTAssertEqual(l.p0, l.startingPoint)
        XCTAssertEqual(l.startingPoint, Point(x: 4.0, y: 5.0))
        l.endingPoint = Point(x: 9.0, y: 8.0)
        XCTAssertEqual(l.p1, l.endingPoint)
        XCTAssertEqual(l.endingPoint, Point(x: 9.0, y: 8.0))
    }

    func testDerivative() {
        let l = LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.0, y: 2.0))
        XCTAssertEqual(l.derivative(at: 0.23), Point(x: 2.0, y: 1.0))
    }

    func testSplitFromTo() {
        let l = LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 4.0, y: 7.0))
        let t1 = 1.0 / 3.0
        let t2 = 2.0 / 3.0
        let s = l.split(from: t1, to: t2)
        XCTAssertEqual(s, LineSegment(p0: Point(x: 2.0, y: 3.0), p1: Point(x: 3.0, y: 5.0)))
    }

    func testSplitAt() {
        let l = LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.0, y: 5.0))
        let (left, right) = l.split(at: 0.5)
        XCTAssertEqual(left, LineSegment(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 2.0, y: 3.0)))
        XCTAssertEqual(right, LineSegment(p0: Point(x: 2.0, y: 3.0), p1: Point(x: 3.0, y: 5.0)))
    }

    func testBoundingBox() {
        let l = LineSegment(p0: Point(x: 3.0, y: 5.0), p1: Point(x: 1.0, y: 3.0))
    ...
    func testComputeRealWordIssue() {
        let s = Point(x: 0.30901699437494745, y: 0.9510565162951535)
        let e = Point(x: 0.30901699437494723, y: -0.9510565162951536)
    ...
    func testLength() {
        let l = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 4.0, y: 6.0))
        XCTAssertEqual(l.length(), 5.0)
    }

    func testProject() {
        let l = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 5.0, y: 6.0))
        let p1 = l.project(Point(x: 0.0, y: 0.0)) // should project to p0
        XCTAssertEqual(p1.point, Point(x: 1.0, y: 2.0))
        XCTAssertEqual(p1.t, 0.0)
        let p2 = l.project(Point(x: 1.0, y: 4.0)) // should project to l.compute(0.25)
        XCTAssertEqual(p2.point, Point(x: 2.0, y: 3.0))
        XCTAssertEqual(p2.t, 0.25)
        let p3 = l.project(Point(x: 6.0, y: 7.0))
        XCTAssertEqual(p3.point, Point(x: 5.0, y: 6.0)) // should project to p1
        XCTAssertEqual(p3.t, 1.0)
    }

    func testHull() {
        let l = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 3.0, y: 4.0))
        let h = l.hull(0.5)
        XCTAssert(h.count == 3)
    ...
    func testSelfIntersects() {
        let l = LineSegment(p0: Point(x: 3.0, y: 4.0), p1: Point(x: 5.0, y: 6.0))
    ...
    func testIntersectionsLineYesInsideInterval() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 7.0, y: 8.0))
        let l2 = LineSegment(p0: Point(x: 1.0, y: 4.0), p1: Point(x: 5.0, y: 0.0))
    ...
    func testIntersectionsLineNoOutsideInterval1() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 1.0, y: 2.0))
        let l2 = LineSegment(p0: Point(x: 0.0, y: 2.001), p1: Point(x: 2.0, y: 2.001))
        let i = l1.intersections(with: l2)
        XCTAssert(i.isEmpty)
    }
    ...
    func testIntersectionsLineNoOutsideInterval2() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 1.0, y: 2.0))
        let l2 = LineSegment(p0: Point(x: 2.0, y: 1.0), p1: Point(x: 1.001, y: 1.0))
        let i = l1.intersections(with: l2)
        XCTAssert(i.isEmpty)
    }
    ...
    func testIntersectionsLineYesEdge1() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 1.0, y: 2.0))
        let l2 = LineSegment(p0: Point(x: 2.0, y: 1.0), p1: Point(x: 1.0, y: 1.0))
        let i = l1.intersections(with: l2)
        XCTAssertEqual(i.count, 1)
    ...
    func testIntersectionsLineYesEdge2() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 1.0, y: 2.0))
        let l2 = LineSegment(p0: Point(x: 0.0, y: 2.0), p1: Point(x: 2.0, y: 2.0))
        let i = l1.intersections(with: l2)
        XCTAssertEqual(i.count, 1)
    ...
    func testIntersectionsLineYesLineStart() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 2.0, y: 1.0))
        let l2 = LineSegment(p0: Point(x: -2.0, y: 2.0), p1: Point(x: 1.0, y: 0.0))
        let i = l1.intersections(with: l2)
        XCTAssertEqual(i.count, 1)
    ...
    func testIntersectionsLineYesLineEnd() {
        ...
        let l1 = LineSegment(p0: Point(x: 1.0, y: 0.0), p1: Point(x: 2.0, y: 1.0))
        let l2 = LineSegment(p0: Point(x: 2.0, y: 1.0), p1: Point(x: -2.0, y: 2.0))
        let i = l1.intersections(with: l2)
        XCTAssertEqual(i.count, 1)
        XCTAssertEqual(i[0].t1, 1.0)
    ...
    func testIntersectionsLineAsCurve() {
        ...
        let l1 = LineSegment(p0: Point(x: 0.0, y: 0.0), p1: Point(x: 1.0, y: 1.0))
        let l2: BezierCurve = LineSegment(p0: Point(x: 0.0, y: 1.0), p1: Point(x: 1.0, y: 0.0)) as BezierCurve
    ...
    func testIntersectionsLineNoParallel() {
        ...
        let l1 = LineSegment(p0: Point(x: -2.0, y: -1.0), p1: Point(x: 2.0, y: 1.0))
        let l2 = LineSegment(p0: Point(x: -4.0, y: -1.0), p1: Point(x: 4.0, y: 3.0))
        let i1 = l1.intersections(with: l2)
        XCTAssertTrue(i1.isEmpty)

        // very, very nearly parallel lines
        let l5 = LineSegment(p0: Point(x: 0.0, y: 0.0), p1: Point(x: 1.0, y: 1.0))
        let l6 = LineSegment(p0: Point(x: 0.0, y: 1.0), p1: Point(x: 1.0, y: 2.0 + 1.0e-15))
    ...
    func testIntersectionsLineYesCoincidentBasic() {
        ...
        let l1 = LineSegment(p0: Point(x: -5.0, y: -5.0), p1: Point(x: 5.0, y: 5.0))
        let l2 = LineSegment(p0: Point(x: -1.0, y: -1.0), p1: Point(x: 1.0, y: 1.0))
        let i1 = l1.intersections(with: l2)
        XCTAssertEqual(i1, [Intersection(t1: 0.4, t2: 0), Intersection(t1: 0.6, t2: 1)])

        // coincident at the start
        let l3 = LineSegment(p0: Point(x: 1, y: 1), p1: Point(x: 3, y: 3))
        let l4 = LineSegment(p0: Point(x: 1, y: 1), p1: Point(x: 2, y: 2))
        ...
        let l5 = LineSegment(p0: Point(x: 1, y: 1), p1: Point(x: 3, y: -1))
        let l6 = LineSegment(p0: Point(x: 3, y: -1), p1: Point(x: 2, y: 0))
        let i3 = l5.intersections(with: l6)
        XCTAssertEqual(i3, [Intersection(t1: 0.5, t2: 1), Intersection(t1: 1, t2: 0)])

        // lines should be fully coincident with themselves
        let l7 = LineSegment(p0: Point(x: 1.863, y: 23.812), p1: Point(x: -4.876, y: 3.652))
    ...
    func testIntersectionsLineYesCoincidentRealWorldData() {
        let l1 = LineSegment(p0: Point(x: 134.76833383678579, y: 95.05360294098101),
                             p1: Point(x: 171.33627533401454, y: 102.89462632327792))
        let l2 = LineSegment(p0: Point(x: 111.2, y: 90.0),
                             p1: Point(x: 171.33627533401454, y: 102.89462632327792))
        let i = l1.intersections(with: l2)
    ...
    func testIntersectionsLineNotCoincidentRealWorldData() {
        ...
        let line1 = LineSegment(p0: Point(x: 207.15663697593666, y: 105.38213850350812), p1: Point(x: 203.27567019330237, y: 95.49245438213565))
        let line2 = LineSegment(p0: Point(x: 199.5505907010711, y: 85.41166231873908), p1: Point(x: 203.27567019330286, y: 95.4924543821369))
    ...
    func testIntersectionsQuadratic() {
        ...
        let epsilon = 0.00001
        let q = QuadraticCurve(start: Point(x: 0.0, y: 0.0),
                               end: Point(x: 2.0, y: 0.0),
                               mid: Point(x: 1.0, y: 2.0),
                               t: 0.5)
        let l1 = LineSegment(p0: Point(x: -1.0, y: 1.0), p1: Point(x: 3.0, y: 1.0))
        let l2 = LineSegment(p0: Point(x: 3.0, y: 1.0), p1: Point(x: -1.0, y: 1.0)) // same line as l1, but reversed
    ...
    func testIntersectionsQuadraticSpecialCase() {
        ...
        let l = LineSegment(p0: Point(x: -1, y: 0), p1: Point(x: 1, y: 0))
        let q = QuadraticCurve(p0: Point(x: 0, y: 0), p1: Point(x: -1, y: 0), p2: Point(x: -1, y: 1))
    ...
    func testIntersectionsCubic() {
        // we mostly just care that we call into the proper implementation and that the results are ordered correctly
        let epsilon = 0.00001
        let c = CubicCurve(p0: Point(x: -1, y: 0),
                           p1: Point(x: -1, y: 1),
                           p2: Point(x: 1, y: -1),
                           p3: Point(x: 1, y: 0))
        let l1 = LineSegment(p0: Point(x: -2.0, y: 0.0), p1: Point(x: 2.0, y: 0.0))
        ...
        let l2 = LineSegment(p0: Point(x: 2.0, y: 0.0), p1: Point(x: -2.0, y: 0.0))
    ...
    func testIntersectionsCubicRealWorldIssue() {
        ...
        let cubicCurve = CubicCurve(p0: Point(x: 301.42017404234923, y: 182.42157189005232),
        ...
        let line = LineSegment(p0: Point(x: 309.54962994198274, y: 187.61824016482512), p1: Point(x: 275.83899279843945, y: 187.61824016482512))
    ...
    func testIntersectionsDegenerateCubic1() {
        ...
        let c = CubicCurve(p0: Point(x: 1.0, y: 1.0),
                           p1: Point(x: fiveThirds, y: fiveThirds),
                           p2: Point(x: sevenThirds, y: fiveThirds),
                           p3: Point(x: 3.0, y: 1.0))
        let l = LineSegment(p0: Point(x: 1.0, y: 1.1), p1: Point(x: 3.0, y: 1.1))
    ...
    func testIntersectionsDegenerateCubic2() {
        ...
        let l = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 4.0, y: 2.0))
        let i = l.intersections(with: c)
        XCTAssertEqual(i.count, 1)
        XCTAssert(BezierKitTestHelpers.intersections(i, betweenCurve: l, andOtherCurve: c, areWithinTolerance: epsilon))
    }
    ...
    func testIntersectionsCubicSpecialCase() {
        // this is case that failed in the real-world
        let l = LineSegment(p0: Point(x: -1, y: 0), p1: Point(x: 1, y: 0))
        let q = CubicCurve(quadratic: QuadraticCurve(p0: Point(x: 0, y: 0), p1: Point(x: -1, y: 0), p2: Point(x: -1, y: 1)))
        let i = l.intersections(with: q)
        XCTAssertEqual(i.count, 1)
        XCTAssertEqual(i.first?.t1, 0.5)
        XCTAssertEqual(i.first?.t2, 0)
    ...
    func testIntersectionsCubicRootsEdgeCase1() {
        ...
        let c = CubicCurve(p0: Point(x: 201.48419096574196, y: 570.7720830272123),
        ...
        let l = LineSegment(p0: Point(x: 200.05889802679428, y: 572.1973759661599), p1: Point(x: 201.48419096574196, y: 573.6226689051076))
        let i = l.intersections(with: c)
        XCTAssertEqual(i, [])
    }
    ...
    func testIntersectionsCubicRootsEdgeCase2() {
        ...
        let line = LineSegment(p0: Point(x: 503.31162501468725, y: 766.9016671863201),
                               p1: Point(x: 504.2124710211739, y: 767.3358059574488))
        let curve = CubicCurve(p0: Point(x: 505.16132944417086, y: 779.6305912206088),
        ...
        XCTAssertEqual(i.count, 2)
        for item in i {
            let d = distance(line.point(at: item.t1), curve.point(at: item.t2))
            XCTAssertTrue(d < 1.0e-4, "distance line.compute(\(item.t1)) to curve.compute(\(item.t2)) = \(d)")
        }
    }
    ...
    func testEquatable() {
        let l1 = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 3.0, y: 4.0))
        let l2 = LineSegment(p0: Point(x: 1.0, y: 3.0), p1: Point(x: 3.0, y: 4.0))
        let l3 = LineSegment(p0: Point(x: 1.0, y: 2.0), p1: Point(x: 3.0, y: 5.0))
