...
//
    func testInitializerStartEndMidT() {
        let q1 = QuadraticCurve(start: Point(x: 1.0, y: 1.0), end: Point(x: 5.0, y: 1.0), mid: Point(x: 3.0, y: 2.0), t: 0.5)
        XCTAssertEqual(q1, QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.0, y: 3.0), p2: Point(x: 5.0, y: 1.0)))
        // degenerate cases
        let q2 = QuadraticCurve(start: Point(x: 1.0, y: 1.0), end: Point(x: 5.0, y: 1.0), mid: Point(x: 1.0, y: 1.0), t: 0.0)
        XCTAssertEqual(q2, QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 1.0, y: 1.0), p2: Point(x: 5.0, y: 1.0)))
        let q3 = QuadraticCurve(start: Point(x: 1.0, y: 1.0), end: Point(x: 5.0, y: 1.0), mid: Point(x: 5.0, y: 1.0), t: 1.0)
        XCTAssertEqual(q3, QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 5.0, y: 1.0), p2: Point(x: 5.0, y: 1.0)))
    }

    func testBasicProperties() {
        let q = QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.5, y: 2.0), p2: Point(x: 6.0, y: 1.0))
        XCTAssert(q.simple)
        XCTAssertEqual(q.order, 2)
        XCTAssertEqual(q.startingPoint, Point(x: 1.0, y: 1.0))
        XCTAssertEqual(q.endingPoint, Point(x: 6.0, y: 1.0))
    }

    func testSetStartEndPoints() {
        var q = QuadraticCurve(p0: Point(x: 5.0, y: 6.0), p1: Point(x: 6.0, y: 5.0), p2: Point(x: 8.0, y: 7.0))
        q.startingPoint = Point(x: 4.0, y: 5.0)
        XCTAssertEqual(q.p0, q.startingPoint)
        XCTAssertEqual(q.startingPoint, Point(x: 4.0, y: 5.0))
        q.endingPoint = Point(x: 9.0, y: 8.0)
        XCTAssertEqual(q.p2, q.endingPoint)
        XCTAssertEqual(q.endingPoint, Point(x: 9.0, y: 8.0))
    }
...
//
    func testBoundingBox() {
        ...
        let q1 = QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: 3.0, y: 3.0), p2: Point(x: 5.0, y: 1.0))
        ...
        let q2 = QuadraticCurve(p0: Point(x: 1.0, y: 1.0), p1: Point(x: -1.0, y: 2.0), p2: Point(x: 1.0, y: 3.0))
...
//
    ...
    func testProject() {
        ...
        let q = QuadraticCurve(p0: Point(x: 1, y: 1),
                               p1: Point(x: 2, y: 0),
                               p2: Point(x: 4, y: 1))
        let result1 = q.project(Point(x: 2, y: 2))
        XCTAssertEqual(result1.t, 0)
        XCTAssertEqual(result1.point, Point(x: 1, y: 1))
        let result2 = q.project(Point(x: 5, y: 1))
        XCTAssertEqual(result2.t, 1)
        XCTAssertEqual(result2.point, Point(x: 4, y: 1))
        let result3 = q.project(Point(x: 2.25, y: 1))
        XCTAssertEqual(result3.t, 0.5)
        XCTAssertEqual(result3.point, Point(x: 2.25, y: 0.5))
        // test accuracy
        let t = 0.374858262
...
//
    func testIntersectionsQuadratic() {
        let epsilon = 1.0e-5
        let q1 = QuadraticCurve(start: Point(x: 0.0, y: 0.0),
                                end: Point(x: 2.0, y: 0.0),
                                mid: Point(x: 1.0, y: 2.0),
                                t: 0.5)
        let q2 = QuadraticCurve(start: Point(x: 0.0, y: 2.0),
        ...
        let expectedResult1 = Point(x: root1, y: 1)
        let expectedResult2 = Point(x: root2, y: 1)
    ...
    func testIntersectionQuadraticColinearControlPoints() {
        ...
        let epsilon = 1.0e-5
        let quadraticWithColinearControlPoints = QuadraticCurve(p0: Point(x: 1, y: 1),
                                                                p1: Point(x: 3, y: 3),
                                                                p2: Point(x: 2, y: 2))
        let quadratic = QuadraticCurve(p0: Point(x: 0, y: 0),
                                       p1: Point(x: 1, y: 4),
                                       p2: Point(x: 2, y: 0))
    ...
    func testIntersectionQuadraticButActuallyLinear() {
        ...
        let epsilon = 1.0e-5
        let quadraticButActuallyLinear = QuadraticCurve(p0: Point(x: 2, y: 1),
                                                        p1: Point(x: 3, y: 2),
                                                        p2: Point(x: 4, y: 3))
        let quadratic = QuadraticCurve(p0: Point(x: 0, y: 0),
                                       p1: Point(x: 3.5, y: 5),
    ...
    func testEquatable() {
        ...
        let c3 = QuadraticCurve(p0: Point(x: 5.0, y: 6.0), p1: p1, p2: p2)
        let c4 = QuadraticCurve(p0: p0, p1: Point(x: 1.0, y: 3.0), p2: p2)
        let c5 = QuadraticCurve(p0: p0, p1: p1, p2: Point(x: 3.0, y: 6.0))
