...
class FlatnessTests: XCTestCase {
    let line = LineSegment(p0: Point(x: 1, y: 2), p1: Point(x: 3, y: 4))

    let quadratic1 = QuadraticCurve(p0: Point(x: 1, y: 2),
                                    p1: Point(x: 2, y: 3),
                                    p2: Point(x: 3, y: 2))

    let quadratic2 = QuadraticCurve(p0: Point(x: 1, y: 1),
                                    p1: Point(x: 3, y: 2),
                                    p2: Point(x: 1, y: 3))

    let cubic1 = CubicCurve(p0: Point(x: 1, y: 2),
                            p1: Point(x: 2, y: 3),
                            p2: Point(x: 3, y: 2),
                            p3: Point(x: 4, y: 2))

    let cubic2 = CubicCurve(p0: Point(x: 2, y: 1),
                            p1: Point(x: 2, y: 2),
                            p2: Point(x: 3, y: 3),
                            p3: Point(x: 2, y: 4))
